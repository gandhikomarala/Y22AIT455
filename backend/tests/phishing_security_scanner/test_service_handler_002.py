"""Unit tests for phishing_security_scanner handler node 002."""
import pytest
from backend.services.phishing_security_scanner.service_handler_002 import ServiceHandlerNode002, ServicePayload002
