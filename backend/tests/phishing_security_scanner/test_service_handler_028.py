"""Unit tests for phishing_security_scanner handler node 028."""
import pytest
from backend.services.phishing_security_scanner.service_handler_028 import ServiceHandlerNode028, ServicePayload028
