"""Unit tests for phishing_security_scanner handler node 010."""
import pytest
from backend.services.phishing_security_scanner.service_handler_010 import ServiceHandlerNode010, ServicePayload010
