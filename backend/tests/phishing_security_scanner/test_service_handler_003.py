"""Unit tests for phishing_security_scanner handler node 003."""
import pytest
from backend.services.phishing_security_scanner.service_handler_003 import ServiceHandlerNode003, ServicePayload003
