"""Unit tests for phishing_security_scanner handler node 004."""
import pytest
from backend.services.phishing_security_scanner.service_handler_004 import ServiceHandlerNode004, ServicePayload004
