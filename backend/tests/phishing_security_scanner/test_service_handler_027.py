"""Unit tests for phishing_security_scanner handler node 027."""
import pytest
from backend.services.phishing_security_scanner.service_handler_027 import ServiceHandlerNode027, ServicePayload027
