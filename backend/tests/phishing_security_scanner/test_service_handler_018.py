"""Unit tests for phishing_security_scanner handler node 018."""
import pytest
from backend.services.phishing_security_scanner.service_handler_018 import ServiceHandlerNode018, ServicePayload018
