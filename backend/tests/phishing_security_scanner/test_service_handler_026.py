"""Unit tests for phishing_security_scanner handler node 026."""
import pytest
from backend.services.phishing_security_scanner.service_handler_026 import ServiceHandlerNode026, ServicePayload026
