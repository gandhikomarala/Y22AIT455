"""Unit tests for phishing_security_scanner handler node 008."""
import pytest
from backend.services.phishing_security_scanner.service_handler_008 import ServiceHandlerNode008, ServicePayload008
