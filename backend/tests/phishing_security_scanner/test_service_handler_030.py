"""Unit tests for phishing_security_scanner handler node 030."""
import pytest
from backend.services.phishing_security_scanner.service_handler_030 import ServiceHandlerNode030, ServicePayload030
