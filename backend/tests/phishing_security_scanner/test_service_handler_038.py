"""Unit tests for phishing_security_scanner handler node 038."""
import pytest
from backend.services.phishing_security_scanner.service_handler_038 import ServiceHandlerNode038, ServicePayload038
