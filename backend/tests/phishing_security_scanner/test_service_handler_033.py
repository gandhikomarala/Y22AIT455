"""Unit tests for phishing_security_scanner handler node 033."""
import pytest
from backend.services.phishing_security_scanner.service_handler_033 import ServiceHandlerNode033, ServicePayload033
