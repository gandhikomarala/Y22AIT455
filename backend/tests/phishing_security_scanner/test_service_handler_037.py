"""Unit tests for phishing_security_scanner handler node 037."""
import pytest
from backend.services.phishing_security_scanner.service_handler_037 import ServiceHandlerNode037, ServicePayload037
