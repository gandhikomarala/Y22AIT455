"""Unit tests for phishing_security_scanner handler node 020."""
import pytest
from backend.services.phishing_security_scanner.service_handler_020 import ServiceHandlerNode020, ServicePayload020
