"""Unit tests for phishing_security_scanner handler node 013."""
import pytest
from backend.services.phishing_security_scanner.service_handler_013 import ServiceHandlerNode013, ServicePayload013
