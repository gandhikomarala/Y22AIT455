"""Unit tests for phishing_security_scanner handler node 025."""
import pytest
from backend.services.phishing_security_scanner.service_handler_025 import ServiceHandlerNode025, ServicePayload025
