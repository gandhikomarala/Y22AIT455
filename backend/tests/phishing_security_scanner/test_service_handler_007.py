"""Unit tests for phishing_security_scanner handler node 007."""
import pytest
from backend.services.phishing_security_scanner.service_handler_007 import ServiceHandlerNode007, ServicePayload007
