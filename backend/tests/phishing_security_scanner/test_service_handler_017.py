"""Unit tests for phishing_security_scanner handler node 017."""
import pytest
from backend.services.phishing_security_scanner.service_handler_017 import ServiceHandlerNode017, ServicePayload017
