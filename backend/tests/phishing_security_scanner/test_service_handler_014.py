"""Unit tests for phishing_security_scanner handler node 014."""
import pytest
from backend.services.phishing_security_scanner.service_handler_014 import ServiceHandlerNode014, ServicePayload014
