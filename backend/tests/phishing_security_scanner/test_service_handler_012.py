"""Unit tests for phishing_security_scanner handler node 012."""
import pytest
from backend.services.phishing_security_scanner.service_handler_012 import ServiceHandlerNode012, ServicePayload012
