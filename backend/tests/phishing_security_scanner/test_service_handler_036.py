"""Unit tests for phishing_security_scanner handler node 036."""
import pytest
from backend.services.phishing_security_scanner.service_handler_036 import ServiceHandlerNode036, ServicePayload036
