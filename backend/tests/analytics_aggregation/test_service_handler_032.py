"""Unit tests for analytics_aggregation handler node 032."""
import pytest
from backend.services.analytics_aggregation.service_handler_032 import ServiceHandlerNode032, ServicePayload032
