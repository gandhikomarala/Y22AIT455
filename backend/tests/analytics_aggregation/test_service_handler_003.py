"""Unit tests for analytics_aggregation handler node 003."""
import pytest
from backend.services.analytics_aggregation.service_handler_003 import ServiceHandlerNode003, ServicePayload003
