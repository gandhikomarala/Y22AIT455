"""Unit tests for analytics_aggregation handler node 004."""
import pytest
from backend.services.analytics_aggregation.service_handler_004 import ServiceHandlerNode004, ServicePayload004
