"""Unit tests for analytics_aggregation handler node 025."""
import pytest
from backend.services.analytics_aggregation.service_handler_025 import ServiceHandlerNode025, ServicePayload025
