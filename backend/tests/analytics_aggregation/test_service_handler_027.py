"""Unit tests for analytics_aggregation handler node 027."""
import pytest
from backend.services.analytics_aggregation.service_handler_027 import ServiceHandlerNode027, ServicePayload027
