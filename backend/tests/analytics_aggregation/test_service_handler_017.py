"""Unit tests for analytics_aggregation handler node 017."""
import pytest
from backend.services.analytics_aggregation.service_handler_017 import ServiceHandlerNode017, ServicePayload017
