"""Unit tests for analytics_aggregation handler node 006."""
import pytest
from backend.services.analytics_aggregation.service_handler_006 import ServiceHandlerNode006, ServicePayload006
