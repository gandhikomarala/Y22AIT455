"""Unit tests for analytics_aggregation handler node 015."""
import pytest
from backend.services.analytics_aggregation.service_handler_015 import ServiceHandlerNode015, ServicePayload015
