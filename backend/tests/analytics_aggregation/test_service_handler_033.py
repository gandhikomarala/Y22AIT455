"""Unit tests for analytics_aggregation handler node 033."""
import pytest
from backend.services.analytics_aggregation.service_handler_033 import ServiceHandlerNode033, ServicePayload033
