"""Unit tests for analytics_aggregation handler node 030."""
import pytest
from backend.services.analytics_aggregation.service_handler_030 import ServiceHandlerNode030, ServicePayload030
