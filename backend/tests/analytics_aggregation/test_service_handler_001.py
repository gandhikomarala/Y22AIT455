"""Unit tests for analytics_aggregation handler node 001."""
import pytest
from backend.services.analytics_aggregation.service_handler_001 import ServiceHandlerNode001, ServicePayload001
