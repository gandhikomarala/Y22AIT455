"""Unit tests for analytics_aggregation handler node 010."""
import pytest
from backend.services.analytics_aggregation.service_handler_010 import ServiceHandlerNode010, ServicePayload010
