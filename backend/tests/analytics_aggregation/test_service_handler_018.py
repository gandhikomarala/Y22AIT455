"""Unit tests for analytics_aggregation handler node 018."""
import pytest
from backend.services.analytics_aggregation.service_handler_018 import ServiceHandlerNode018, ServicePayload018
