"""Unit tests for analytics_aggregation handler node 037."""
import pytest
from backend.services.analytics_aggregation.service_handler_037 import ServiceHandlerNode037, ServicePayload037
