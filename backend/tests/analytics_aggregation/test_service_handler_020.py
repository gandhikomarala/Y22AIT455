"""Unit tests for analytics_aggregation handler node 020."""
import pytest
from backend.services.analytics_aggregation.service_handler_020 import ServiceHandlerNode020, ServicePayload020
