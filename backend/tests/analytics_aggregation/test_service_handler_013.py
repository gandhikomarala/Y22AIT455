"""Unit tests for analytics_aggregation handler node 013."""
import pytest
from backend.services.analytics_aggregation.service_handler_013 import ServiceHandlerNode013, ServicePayload013
