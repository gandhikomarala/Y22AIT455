"""Unit tests for analytics_aggregation handler node 008."""
import pytest
from backend.services.analytics_aggregation.service_handler_008 import ServiceHandlerNode008, ServicePayload008
