"""Unit tests for clickstream_telemetry handler node 020."""
import pytest
from backend.services.clickstream_telemetry.service_handler_020 import ServiceHandlerNode020, ServicePayload020
