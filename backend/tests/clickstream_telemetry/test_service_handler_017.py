"""Unit tests for clickstream_telemetry handler node 017."""
import pytest
from backend.services.clickstream_telemetry.service_handler_017 import ServiceHandlerNode017, ServicePayload017
