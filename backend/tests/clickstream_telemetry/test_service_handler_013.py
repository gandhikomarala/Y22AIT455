"""Unit tests for clickstream_telemetry handler node 013."""
import pytest
from backend.services.clickstream_telemetry.service_handler_013 import ServiceHandlerNode013, ServicePayload013
