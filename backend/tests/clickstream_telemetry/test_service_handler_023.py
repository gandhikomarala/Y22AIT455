"""Unit tests for clickstream_telemetry handler node 023."""
import pytest
from backend.services.clickstream_telemetry.service_handler_023 import ServiceHandlerNode023, ServicePayload023
