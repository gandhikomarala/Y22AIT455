"""Unit tests for edge_redirection_engine handler node 023."""
import pytest
from backend.services.edge_redirection_engine.service_handler_023 import ServiceHandlerNode023, ServicePayload023
