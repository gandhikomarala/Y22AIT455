"""Unit tests for edge_redirection_engine handler node 012."""
import pytest
from backend.services.edge_redirection_engine.service_handler_012 import ServiceHandlerNode012, ServicePayload012
