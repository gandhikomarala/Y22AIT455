"""Unit tests for edge_redirection_engine handler node 008."""
import pytest
from backend.services.edge_redirection_engine.service_handler_008 import ServiceHandlerNode008, ServicePayload008
