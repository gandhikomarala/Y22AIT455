"""Unit tests for edge_redirection_engine handler node 003."""
import pytest
from backend.services.edge_redirection_engine.service_handler_003 import ServiceHandlerNode003, ServicePayload003
