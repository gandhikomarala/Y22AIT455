"""Unit tests for edge_redirection_engine handler node 017."""
import pytest
from backend.services.edge_redirection_engine.service_handler_017 import ServiceHandlerNode017, ServicePayload017
