"""Unit tests for edge_redirection_engine handler node 020."""
import pytest
from backend.services.edge_redirection_engine.service_handler_020 import ServiceHandlerNode020, ServicePayload020
