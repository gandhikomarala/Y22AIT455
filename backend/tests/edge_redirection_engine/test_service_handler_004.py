"""Unit tests for edge_redirection_engine handler node 004."""
import pytest
from backend.services.edge_redirection_engine.service_handler_004 import ServiceHandlerNode004, ServicePayload004
