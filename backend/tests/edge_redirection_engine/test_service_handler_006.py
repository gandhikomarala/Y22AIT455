"""Unit tests for edge_redirection_engine handler node 006."""
import pytest
from backend.services.edge_redirection_engine.service_handler_006 import ServiceHandlerNode006, ServicePayload006
