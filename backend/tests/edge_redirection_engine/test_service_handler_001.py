"""Unit tests for edge_redirection_engine handler node 001."""
import pytest
from backend.services.edge_redirection_engine.service_handler_001 import ServiceHandlerNode001, ServicePayload001
