"""Unit tests for key_generation_service handler node 006."""
import pytest
from backend.services.key_generation_service.service_handler_006 import ServiceHandlerNode006, ServicePayload006
