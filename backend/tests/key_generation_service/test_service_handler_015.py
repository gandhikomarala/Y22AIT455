"""Unit tests for key_generation_service handler node 015."""
import pytest
from backend.services.key_generation_service.service_handler_015 import ServiceHandlerNode015, ServicePayload015
