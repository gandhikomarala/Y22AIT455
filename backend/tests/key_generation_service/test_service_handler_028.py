"""Unit tests for key_generation_service handler node 028."""
import pytest
from backend.services.key_generation_service.service_handler_028 import ServiceHandlerNode028, ServicePayload028
