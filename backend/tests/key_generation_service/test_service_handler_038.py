"""Unit tests for key_generation_service handler node 038."""
import pytest
from backend.services.key_generation_service.service_handler_038 import ServiceHandlerNode038, ServicePayload038
