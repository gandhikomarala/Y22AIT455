"""Unit tests for key_generation_service handler node 012."""
import pytest
from backend.services.key_generation_service.service_handler_012 import ServiceHandlerNode012, ServicePayload012
