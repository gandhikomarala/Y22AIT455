"""Unit tests for key_generation_service handler node 033."""
import pytest
from backend.services.key_generation_service.service_handler_033 import ServiceHandlerNode033, ServicePayload033
