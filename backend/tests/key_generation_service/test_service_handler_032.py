"""Unit tests for key_generation_service handler node 032."""
import pytest
from backend.services.key_generation_service.service_handler_032 import ServiceHandlerNode032, ServicePayload032
