"""Unit tests for key_generation_service handler node 027."""
import pytest
from backend.services.key_generation_service.service_handler_027 import ServiceHandlerNode027, ServicePayload027
