"""Unit tests for key_generation_service handler node 037."""
import pytest
from backend.services.key_generation_service.service_handler_037 import ServiceHandlerNode037, ServicePayload037
