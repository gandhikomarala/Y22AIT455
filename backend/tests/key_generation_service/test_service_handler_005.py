"""Unit tests for key_generation_service handler node 005."""
import pytest
from backend.services.key_generation_service.service_handler_005 import ServiceHandlerNode005, ServicePayload005
