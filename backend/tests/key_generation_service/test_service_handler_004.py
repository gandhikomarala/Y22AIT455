"""Unit tests for key_generation_service handler node 004."""
import pytest
from backend.services.key_generation_service.service_handler_004 import ServiceHandlerNode004, ServicePayload004
