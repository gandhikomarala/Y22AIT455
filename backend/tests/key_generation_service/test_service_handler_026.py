"""Unit tests for key_generation_service handler node 026."""
import pytest
from backend.services.key_generation_service.service_handler_026 import ServiceHandlerNode026, ServicePayload026
