"""Unit tests for key_generation_service handler node 036."""
import pytest
from backend.services.key_generation_service.service_handler_036 import ServiceHandlerNode036, ServicePayload036
