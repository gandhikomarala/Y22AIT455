"""Unit tests for key_generation_service handler node 001."""
import pytest
from backend.services.key_generation_service.service_handler_001 import ServiceHandlerNode001, ServicePayload001
