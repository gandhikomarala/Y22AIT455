"""Unit tests for key_generation_service handler node 025."""
import pytest
from backend.services.key_generation_service.service_handler_025 import ServiceHandlerNode025, ServicePayload025
